...
class pdfGenerator extends Controller {
    ...
    public function generate(Request $request) {
        ...
        $pdf->loadHtml($this->getForm($request))
            ->setPaper('a4')
            ->setOption('encoding', 'UTF-8')
            ->setOption('user-style-sheet', public_path().'/styles/main.2ce5265d.css')
            ->setOption('run-script', array(
                public_path().'/scripts/scripts.3ba4f658.js',
                public_path().'/scripts/vendor.45dad3d2.js'
            ));
                        ...
                        <nav class="navbar navbar-default">
                            <div class="container-fluid">
                                <div class="form-group" role="form" id="formulaire">
                                    <div class="form-group col-xs-6 col-ms-6 col-md-6 col-lg-6">
                        ...
                        <div class="panel-body table-responsive">
                            <table class="table table-responsive">
                                ...
                                <tr>
                                    ...
                                    <th class="col-lg-1 col-md-1 col-ms-1 col-xs-1"> > 5</th>
                                    <th class="col-lg-1 col-md-1 col-ms-1 col-xs-1"> > 10</th>
                                    <th class="col-lg-1 col-md-1 col-ms-1 col-xs-1"> < 10</th>
                                </tr>
                                </thead>
                                <tbody>
